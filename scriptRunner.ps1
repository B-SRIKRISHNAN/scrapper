...
$input | Out-File -FilePath "C:\Users\bsk19\OneDrive\Desktop\BSK\my pet projects\scrapper\projectConfig.txt" -encoding utf8

# $path = "OneDrive\Desktop\BSK\Project to fill my song and podcast db\scrapper\testScrapper.js"
Set-Location "./Onedrive/Desktop/BSK/my pet projects/scrapper"
...
mkdir security
mkdir filter
copy-item -path "C:\Users\bsk19\OneDrive\Desktop\BSK\my pet projects\scrapper\LoggerAspect.java" -Destination "./aspects"
Set-Location ../../../../resources
# new-item logback.xml
$pathToCopy = Get-Location
copy-item -Path "C:\Users\bsk19\OneDrive\Desktop\BSK\my pet projects\scrapper\logback.xml" -Destination $pathToCopy
